    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold">Shaheen Birds Paradise</h3>
            <p className="mt-2">Buy Exotic and well trained Birds</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center">
          <p>&copy; {new Date().getFullYear()} Shaheen Birds Paradise. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
